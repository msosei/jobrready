...
export namespace jobs {
    ...
    export class ServiceClient {
        ...
        public async search(params: RequestType<typeof api_jobs_search_search>): Promise<ResponseType<typeof api_jobs_search_search>> {
            ...
            // Now make the actual call to the API
            const resp = await this.baseClient.callTypedAPI(`/jobs/search`, {query, method: "GET", body: undefined})
            return JSON.parse(await resp.text(), dateReviver) as ResponseType<typeof api_jobs_search_search>
        }
    }
}
...
export namespace notifications {
    ...
    export class ServiceClient {
        ...
        public async send(params: RequestType<typeof api_notifications_trigger_send>): Promise<ResponseType<typeof api_notifications_trigger_send>> {
            ...
            return JSON.parse(await resp.text(), dateReviver) as ResponseType<typeof api_notifications_trigger_send>
        }
    }
}
